...
* 🌐 **[AWS Community Globe](https://awscommunityglobe.click/)** *(2026)*  
  What is the best way to visualize 4,000+ AWS community members? By mapping them on an interactive 3D globe.

* ⭐ **[SGSkills](https://sgskills.jagatees.dev/)** *(2026)*  
  A Singapore-first skills marketplace for reusable AI workflows, where developers can discover, view, and install practical skills for local use cases such as GovTech announcements, data.gov.sg analysis, school planning, and policy or news briefing automation.
...
* 🧩 **[Kiro Blueprint](https://kiro-blueprint.vercel.app/)** *(2026)*  
...
* 🌐 **[Personal Website](https://www.jagatees.dev/)** *(2024)*  
  My official portfolio website showcasing my journey, technical skills, and detailed project case studies.


## Work in Progress

* 🕹️ **[Codex ’95](https://github.com/Jagatees/codex-32)** *(2026)*  
  A retro-inspired developer project built around OpenAI Codex, exploring a nostalgic Windows 95-style experience for AI-assisted coding.
